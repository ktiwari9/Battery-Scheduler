...
class PrismModel:
    ...
    def write_prism_file(self, filename, init_b, init_ch):
        ...
        with open(path, 'w') as f:
            ...
            f.write('[gather_reward] (battery<38):1;\n')
            f.write('[stay_charging] (battery<31):1;\n')
            f.write('[go_charge] (battery<31):1;\n')
            f.write('\nendrewards\n\n')
...
if __name__ == '__main__':
    ...
    mm = PrismModel('bc_model_test.prism', 70, 1, task_prob, clusters, prob, charge_model, discharge_model)
...
class BatteryModel:
    ...
    def extract_data(self, files):
        ...
        for file_set in files:
            ...
            #     self.__update_discharging_model(battery_discharge)
            # if not battery_charge.empty:
            #     self.__update_charging_model(battery_charge)
        

        ### CHECK CODE TILL HERE 
        ### UPDATE CODE 

    def __update_charging_model(self,charge_data):

    def __update_discharging_model(self,discharge_data):

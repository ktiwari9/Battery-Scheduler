...
if __name__ == '__main__':
	...
	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,7), datetime(2019,11,8), datetime(2019,11,9)])
	tbrbc1.get_plan('tbrbc1_711811911_1')

	np.random.seed(1)
	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,7), datetime(2019,11,8), datetime(2019,11,9)])
	tbrbc1.get_plan('tbrbc1_711811911_2')

	np.random.seed(2)
	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,7), datetime(2019,11,8), datetime(2019,11,9)])
	tbrbc1.get_plan('tbrbc1_711811911_3')

	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,10), datetime(2019,11,11), datetime(2019,11,12)])
	tbrbc1.get_plan('tbrbc1_101111111211_1')

	np.random.seed(1)
	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,10), datetime(2019,11,11), datetime(2019,11,12)])
	tbrbc1.get_plan('tbrbc1_101111111211_2')

	np.random.seed(2)
	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,10), datetime(2019,11,11), datetime(2019,11,12)])
	tbrbc1.get_plan('tbrbc1_101111111211_3')

	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,13), datetime(2019,11,14), datetime(2019,11,15)])
	tbrbc1.get_plan('tbrbc1_131114111511_1')

	np.random.seed(1)
	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,13), datetime(2019,11,14), datetime(2019,11,15)])
	tbrbc1.get_plan('tbrbc1_131114111511_2')

	np.random.seed(2)
	tbrbc1 = TaskBasedRBC1(70, 1, [datetime(2019,11,13), datetime(2019,11,14), datetime(2019,11,15)])
	tbrbc1.get_plan('tbrbc1_131114111511_3')
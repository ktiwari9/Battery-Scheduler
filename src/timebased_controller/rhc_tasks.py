...
if __name__ == '__main__':
    ...
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,8,30), datetime(2017,8,31), datetime(2017,9,1)], 5)
    # rhct.get_plan('rhct_30831819_1')

    # np.random.seed(1)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,8,30), datetime(2017,8,31), datetime(2017,9,1)], 5)
    # rhct.get_plan('rhct_30831819_2')

    # np.random.seed(2)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,8,30), datetime(2017,8,31), datetime(2017,9,1)], 5)
    # rhct.get_plan('rhct_30831819_3')
    
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,16), datetime(2017,9,17), datetime(2017,9,18)], 5)
    # rhct.get_plan('rhct_169179189_1')

    # np.random.seed(1)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,16), datetime(2017,9,17), datetime(2017,9,18)], 5)
    # rhct.get_plan('rhct_169179189_2')

    # np.random.seed(2)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,16), datetime(2017,9,17), datetime(2017,9,18)], 5)
    # rhct.get_plan('rhct_169179189_3')

    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,24), datetime(2017,9,25), datetime(2017,9,26)], 5)
    # rhct.get_plan('rhct_249259269_1')

    # np.random.seed(1)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,24), datetime(2017,9,25), datetime(2017,9,26)], 5)
    # rhct.get_plan('rhct_249259269_2')

    # np.random.seed(2)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,24), datetime(2017,9,25), datetime(2017,9,26)], 5)
    # rhct.get_plan('rhct_249259269_3')

    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,3), datetime(2017,9,4), datetime(2017,9,5)], 5)
    # rhct.get_plan('rhct_394959_1')

    # np.random.seed(1)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,3), datetime(2017,9,4), datetime(2017,9,5)], 5)
    # rhct.get_plan('rhct_394959_2')

    # np.random.seed(2)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,3), datetime(2017,9,4), datetime(2017,9,5)], 5)
    # rhct.get_plan('rhct_394959_3')

    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,20), datetime(2017,9,21), datetime(2017,9,22)], 5)
    # rhct.get_plan('rhct_209219229_1')

    # np.random.seed(1)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,20), datetime(2017,9,21), datetime(2017,9,22)], 5)
    # rhct.get_plan('rhct_209219229_2')

    # np.random.seed(2)
    # rhct = RecedingHorizonControl(70, 1, [datetime(2017,9,20), datetime(2017,9,21), datetime(2017,9,22)], 5)
    # rhct.get_plan('rhct_209219229_3')

    rhct = RecedingHorizonControl(70, 1, [datetime(2017,10,1), datetime(2017,10,2), datetime(2017,10,3)], 5)
    rhct.get_plan('rhct_110210310_1')

    np.random.seed(1)
    rhct = RecedingHorizonControl(70, 1, [datetime(2017,10,1), datetime(2017,10,2), datetime(2017,10,3)], 5)
    rhct.get_plan('rhct_110210310_2')

    np.random.seed(2)
    rhct = RecedingHorizonControl(70, 1, [datetime(2017,10,1), datetime(2017,10,2), datetime(2017,10,3)], 5)
    rhct.get_plan('rhct_110210310_3')
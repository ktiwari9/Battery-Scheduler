...
class RuleBasedControl:
    ...
    def __init__(self, init_battery, init_charging, test_days, threshold):
...
if __name__ == '__main__':
    ...
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,10), datetime(2017,10,11), datetime(2017,10,12)], threshold)
    rbc3.get_plan('rbc3_101011101210_1')

    np.random.seed(1)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,10), datetime(2017,10,11), datetime(2017,10,12)], threshold)
    rbc3.get_plan('rbc3_101011101210_2')

    np.random.seed(2)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,10), datetime(2017,10,11), datetime(2017,10,12)], threshold)
    rbc3.get_plan('rbc3_101011101210_3')

    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,19), datetime(2017,10,20), datetime(2017,10,21)], threshold)
    rbc3.get_plan('rbc3_191020102110_1')

    np.random.seed(1)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,19), datetime(2017,10,20), datetime(2017,10,21)], threshold)
    rbc3.get_plan('rbc3_191020102110_2')

    np.random.seed(2)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,19), datetime(2017,10,20), datetime(2017,10,21)], threshold)
    rbc3.get_plan('rbc3_191020102110_3')

    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,29), datetime(2017,10,30), datetime(2017,10,31)], threshold)
    rbc3.get_plan('rbc3_291030103110_1')

    np.random.seed(1)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,29), datetime(2017,10,30), datetime(2017,10,31)], threshold)
    rbc3.get_plan('rbc3_291030103110_2')

    np.random.seed(2)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,10,29), datetime(2017,10,30), datetime(2017,10,31)], threshold)
    rbc3.get_plan('rbc3_291030103110_3')

    rbc3 = RuleBasedControl(70, 1, [datetime(2017,11,4), datetime(2017,11,5), datetime(2017,11,6)], threshold)
    rbc3.get_plan('rbc3_411511611_1')

    np.random.seed(1)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,11,4), datetime(2017,11,5), datetime(2017,11,6)], threshold)
    rbc3.get_plan('rbc3_411511611_2')

    np.random.seed(2)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,11,4), datetime(2017,11,5), datetime(2017,11,6)], threshold)
    rbc3.get_plan('rbc3_411511611_3')

    rbc3 = RuleBasedControl(70, 1, [datetime(2017,11,12), datetime(2017,11,13), datetime(2017,11,14)], threshold)
    rbc3.get_plan('rbc3_121113111411_1')

    np.random.seed(1)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,11,12), datetime(2017,11,13), datetime(2017,11,14)], threshold)
    rbc3.get_plan('rbc3_121113111411_2')

    np.random.seed(2)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,11,12), datetime(2017,11,13), datetime(2017,11,14)], threshold)
    rbc3.get_plan('rbc3_121113111411_3')

    rbc3 = RuleBasedControl(70, 1, [datetime(2017,12,1), datetime(2017,12,2), datetime(2017,12,3)], threshold)
    rbc3.get_plan('rbc3_112212312_1')

    np.random.seed(1)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,12,1), datetime(2017,12,2), datetime(2017,12,3)], threshold)
    rbc3.get_plan('rbc3_112212312_2')

    np.random.seed(2)
    rbc3 = RuleBasedControl(70, 1, [datetime(2017,12,1), datetime(2017,12,2), datetime(2017,12,3)], threshold)
    rbc3.get_plan('rbc3_112212312_3')
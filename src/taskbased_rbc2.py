...
if __name__ == '__main__':
    ...
    stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,8,30), datetime(2017,8,31), datetime(2017,9,1)])
    stbrc2.get_plan('stbrc2_30831819_1')

    # np.random.seed(1)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,8,30), datetime(2017,8,31), datetime(2017,9,1)])
    # stbrc2.get_plan('stbrc2_30831819_2')

    # np.random.seed(2)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,8,30), datetime(2017,8,31), datetime(2017,9,1)])
    # stbrc2.get_plan('stbrc2_30831819_3')

    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,3), datetime(2017,9,4), datetime(2017,9,5)])
    # stbrc2.get_plan('stbrc2_394959_1')

    # np.random.seed(1)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,3), datetime(2017,9,4), datetime(2017,9,5)])
    # stbrc2.get_plan('stbrc2_394959_2')

    # np.random.seed(2)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,3), datetime(2017,9,4), datetime(2017,9,5)])
    # stbrc2.get_plan('stbrc2_394959_3')

    stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,16), datetime(2017,9,17), datetime(2017,9,18)])
    stbrc2.get_plan('stbrc2_169179189_1')

    # np.random.seed(1)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,16), datetime(2017,9,17), datetime(2017,9,18)])
    # stbrc2.get_plan('stbrc2_169179189_2')

    # np.random.seed(2)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,16), datetime(2017,9,17), datetime(2017,9,18)])
    # stbrc2.get_plan('stbrc2_169179189_3')

    stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,20), datetime(2017,9,21), datetime(2017,9,22)])
    stbrc2.get_plan('stbrc2_209219229_1')

    # np.random.seed(1)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,20), datetime(2017,9,21), datetime(2017,9,22)])
    # stbrc2.get_plan('stbrc2_209219229_2')

    # np.random.seed(2)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,20), datetime(2017,9,21), datetime(2017,9,22)])
    # stbrc2.get_plan('stbrc2_209219229_3')

    stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,24), datetime(2017,9,25), datetime(2017,9,26)])
    stbrc2.get_plan('stbrc2_249259269_1')

    # np.random.seed(1)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,24), datetime(2017,9,25), datetime(2017,9,26)])
    # stbrc2.get_plan('stbrc2_249259269_2')

    # np.random.seed(2)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,9,24), datetime(2017,9,25), datetime(2017,9,26)])
    # stbrc2.get_plan('stbrc2_249259269_3')

    stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,10,1), datetime(2017,10,2), datetime(2017,10,3)])
    stbrc2.get_plan('stbrc2_110210310_1')

    # np.random.seed(1)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,10,1), datetime(2017,10,2), datetime(2017,10,3)])
    # stbrc2.get_plan('stbrc2_110210310_2')

    # np.random.seed(2)
    # stbrc2 = TaskBasedRBC2(70, 1, [datetime(2017,10,1), datetime(2017,10,2), datetime(2017,10,3)])
    # stbrc2.get_plan('stbrc2_110210310_3')

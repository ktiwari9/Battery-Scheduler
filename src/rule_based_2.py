...
class RuleBasedControl:
	...
	def __init__(self, init_battery, init_charging):
		...
		self.test_rewards = []
		with open('/home/milan/workspace/strands_ws/src/battery_scheduler/data/rbc2_sample_rewards', 'r') as f:
			for line in f:
...
if __name__ == '__main__':
	...
	path = '/home/milan/workspace/strands_ws/src/battery_scheduler/data/rbc2_sample_rewards'

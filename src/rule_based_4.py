...
if __name__ == '__main__':
    ...
    np.random.seed(0)
    f_name = 'rbc4_oct123_40b_1'
    rbc4 = RuleBasedControl(40,1)
    ...
    np.random.seed(0)
    f_name = 'rbc4_oct123_100b_1'
    rbc4 = RuleBasedControl(100,1)

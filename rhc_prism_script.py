...
class make_model:
    ...
    def __init__(self, from_t, init_b, init_ch, init_ob, clusters, prob):
        # initial values that make model. from_t set to zero
        horizon = 48 # for a horizon of 48 time steps
        self.clusters = horizon*[0]
        self.prob = horizon*[0]
    ...
    def write_prism_file(self, init_b, init_ch, init_ob):
        # path to prism files   
        with open(os.path.join('/home/milan/catkin_ws/prism','u_model_t.prism'), 'w') as f:
            f.write('mdp\n\n')
